  ...
  <div class="form">
      ...
      <div class="tab-content">
        ...
        <div id="login">   
          ...
          <br>
           <b><a id="abcde" href="registration.php">Sign Up</a></b><br><br>
           <b><a id="abcde" href="admin_login.php">Are You Admin</a></b>
...
<script  src="js/index.js"></script>
  ...
  <?php
    if(isset($_POST["submit"]))
    {
      ...
      $count=0;
      $res=mysqli_query($link, "select *from jregistration where email='$_POST[t1]' && password='$pwd'");
