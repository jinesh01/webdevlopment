...
<!DOCTYPE html>
  ...
  <head>
    ...
    <link rel="shortcut icon" type="image/png" href="img/favicon.png" sizes="100px">
          ...
          <div class="row fullscreen d-flex align-items-center justify-content-center">
            <div class="banner-content col-lg-7 col-md-6 ">
              <div class="col-lg-10 col-md-7 ">
                <div>
                 <table border="3" align="center" height="350" width="750">
  <tr>
    <td align="center"><font size="5" color="red"><b> ID </b></font></td>
    <td align="center"><font size="5" color="red"><b> CarName</b></font></td>
    <td align="center"><font size="5" color="red"><b>Rent Per Day</b></font></td>
    <td align="center"><font size="5" color="red"><b>Capacity</b></font></td>
    <td align="center"><font size="5" color="red"><b>Edit</b></font></td>
    <td align="center"><font size="5" color="red"><b>Delete</b></font></td>
  </tr>
  <?php
  while($row = mysqli_fetch_array($result))
{
  ...
  <tr>
  <td align="center"><font size="5" color="white"><?php echo $row['id']; ?></font></td>
  <td align="center"><font size="5" color="white"><?php echo $row['car_name']; ?></font></td>
  <td align="center"><font size="5" color="white"><?php echo $row['rent_per_day']; ?></font></td>
  <td align="center"><font size="5" color="white"><?php echo $row['capacity']; ?></font></td>
...
?>
                ...
                <!-- <span class="number" data-number="850000">850,000</span>
              <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><font color="white">Enjoy Your Holidays<br><span>On Our Wheels</font></span></h1> -->
            </div>
            ...
            <!-- <div class="col-lg-5  col-md-6 header-right">
              ...
              <form class="form" role="form" autocomplete="off" action="car.php" method="POST">
                  ...
                  <div class="form-group row">
                      ...
                      <select name="pickup_address">
                        <option value="" disabled selected hidden>Pickup Address</option>
                        <option value="150 ft Ring Road">150 ft Ring Road</option>
                        <option value="University Road">University Road</option>
                        <option value="Kalavad Road">Kalavad Road</option>
                        <option value="Madhapar Chowkdi">Madhapar Chowkdi</option>
                      </select>
                    </div>
                      </div>
                      <div class="col-md-6 wrap-right">
                    <div class="input-group dates-wrap">                                          
                      <input id="datepicker" class="dates form-control" id="exampleAmount" placeholder="Date" type="text" name="pdate">                        
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6 wrap-right">
                    <div class="input-group dates-wrap">                                              
                      <input id="datepicker2" class="dates form-control" id="exampleAmount" placeholder="Date" type="text" name="ddate">                        
                      <div class="input-group-prepend">
                        <span  class="input-group-text"><span class="lnr lnr-calendar-full"></span></span>
                      </div>                      
                    </div>
                  ...
                  <div class="form-group row">
                      <div class="col-md-12">
                          <input type="submit" name="submit" class="btn btn-default btn-lg btn-block text-center text-uppercase" value="Confirm Car Booking">
                      </div>
                  </div>
              </form> 
          </div>
