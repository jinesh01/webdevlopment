<?php
    if(isset($_POST["submit"]))
    {
      ...
      $count=0;
      mysqli_query($link, "insert into product values('','$_POST[t1]','$_POST[t2]','$_POST[t3]')");
      ?>
       <script type="text/javascript">
          alert("Are you sure want to add");
        </script>
        <?php
        echo "Your Record is Successfully add";
     }
?>
<!DOCTYPE html>
              ...
              <div class="col-lg-10 col-md-7 ">
                <div>
                 <form method="post" action="add.php"  name="form">
                                <table border="4" align="center" height="200%" width="30%">
                               <td align="center"><b><font color="Orange" size="5">Car Name</td>
                                <td align="center"><b><font color="Orange" size="5">Rent</th>
                                <td align="center"><b><font color="Orange" size="5">Capacity</th>
                                <tr>           
                                <td><input type="pname" name="t1" placeholder="car_name">
                                </td>
                                <td><input type="pprize" name="t2" placeholder="rent/day"></td>
                                <td><input type="capacity" name="t3" placeholder="capacity"></td>
                                <!-- <input type="" name="t2" placeholder="car_Prize"> -->
                                <td><input class="btn" type="submit" name="submit" value="Submit Now"></td>
                                </tr>
                              </table>
                            </form>
                </div>
