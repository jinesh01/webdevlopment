					...
					<div class="row">
						<div class="col-lg-3 col-md-6 single-blog">
							...
							<div class="meta-bottom d-flex justify-content-between">
								<p><span class="lnr lnr-heart"></span> 15 Likes</p>Da
...

{
	...
	$sql = ("insert into car (car_name,pickup_address,pdate,drop_address,ddate,name,email,phone)values('$car_name','$pickup_address', '$pdate','$drop_address','$ddate', '$name', '$email','$phone')");
	//,'$pri')";
	
	mysqli_query($con,$sql);
	?>
	<script type="text/javascript">
		alert("Your Record Added Successfully");
	</script>
	<?php
}
